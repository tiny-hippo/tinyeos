...
class NearestND(NDInterpolatorBase):
    ...
    @staticmethod
    def __get_weights(dist, weights):
        """
        ...
        Note:
        This function is copied from scikit-learn, specifically from
        sklearn.neighbors._base. It is used to calculate the weight
        maxtrix in the nearest neighbor interpolation.
