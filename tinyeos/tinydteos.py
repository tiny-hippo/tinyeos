...
class TinyDT(InterpolantsBuilder):
    ...
    def __init__(
        ...
        self.interpDT_lfe_x = self.interpDT_x[3]
        self.interpDT_mu_x = self.interpDT_x[4]
        ...
        if self.include_hhe_interactions:
            ...
            self.interpDT_lfe_x_eff = self.interpDT_x_eff[3]
            self.interpDT_mu_x_eff = self.interpDT_x_eff[4]
        ...
        self.interpDT_lfe_y = self.interpDT_y[3]
        self.interpDT_mu_y = self.interpDT_y[4]
    ...
    def __evaluate_x(self, logT: ArrayLike, logRho: ArrayLike) -> NDArray:
        ...
        chiT = self.interpDT_logP_x(logT, logRho, dx=1, **self.kwargs)
        chiRho = self.interpDT_logP_x(logT, logRho, dy=1, **self.kwargs)
    ...
    def __evaluate_x_eff(self, logT: ArrayLike, logRho: ArrayLike) -> NDArray:
        ...
        chiT = self.interpDT_logP_x_eff(logT, logRho, dx=1, **self.kwargs)
        chiRho = self.interpDT_logP_x_eff(logT, logRho, dy=1, **self.kwargs)
    ...
    def __evaluate_y(self, logT: ArrayLike, logRho: ArrayLike) -> NDArray:
        ...
        chiT = self.interpDT_logP_y(logT, logRho, dx=1, **self.kwargs)
        chiRho = self.interpDT_logP_y(logT, logRho, dy=1, **self.kwargs)
